...
public class NumberReceiptServiceTest {
    ...
    public void createObject() {
        ...
        NumberReceiptServiceImpl numberReceiptService = new NumberReceiptServiceImpl(appContext);
